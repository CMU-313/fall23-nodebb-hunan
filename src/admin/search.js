...
function getAdminNamespaces() {
    return __awaiter(this, void 0, void 0, function* () {
        const directories = yield file.walk(
            path.resolve(nconf_1.default.get("views_dir"), "admin"),
        );
...
function initFallback(namespace) {
    return __awaiter(this, void 0, void 0, function* () {
        const template = yield fs.promises.readFile(
            path.resolve(nconf_1.default.get("views_dir"), `${namespace}.tpl`),
            "utf8",
        );
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const title = titleMatch
                ? `[[admin/menu:section-${
                      titleMatch[1] === "development"
                          ? "advanced"
                          : titleMatch[1]
                  }]]${
                      titleMatch[2]
                          ? ` > [[admin/menu:${titleMatch[1]}/${titleMatch[2]}]]`
                          : ""
                  }`
                : "";
